 ...
 * release (same batch as the webver badge in web_page.html). HACS re-registers
 ...
 */
import './keyboard-card.js?v=1.13.0-dev';
import './mouse-card.js?v=1.13.0-dev';
import './remote-card.js?v=1.13.0-dev';
